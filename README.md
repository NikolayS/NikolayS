...
- 📊 [pgseries](https://github.com/NikolayS/pgseries) — TimescaleDB lite, works everywhere: pure SQL/PLpgSQL time-series for Postgres 17+ ([brief](https://nikolays.github.io/pgseries/)).
