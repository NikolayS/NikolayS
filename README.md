...
- 📊 [pgseries](https://github.com/NikolayS/pgseries) — A light alternative to TimescaleDB that works in any Postgres: pure SQL/PLpgSQL time-series for Postgres 17+ ([brief](https://nikolays.github.io/pgseries/)).
